...
Temos duas branches — uma para C# e outra para JS em node.js — é uma API que não utiliza banco de dados. A proposta aqui é estudar tanto **Node.js** quanto **C#**, revisando os conceitos e as particularidades de cada linguagem, armazenando os dados apenas em memória.
...
A branch **NodeJS_33** é a principal, no qual já está funcionando normalmente.